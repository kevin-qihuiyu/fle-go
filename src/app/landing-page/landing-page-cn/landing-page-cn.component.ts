...
@Component({
  selector: 'app-landing-page-cn',
  templateUrl: './landing-page-cn.component.html',
  styleUrls: ['./landing-page-cn.component.scss']
})
export class LandingPageCnComponent implements OnInit {
  returnUrl: string
